...
<member name="T:GSLNET.GSLFunctions.DArrayToDArray" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\gslfunctions.h" line="30">
<summary>入力ベクトルから出力ベクトルを計算する関数</summary>
<param name="inputs">入力ベクトル</param>
<param name="outputs">出力ベクトル</param>
</member>
<member name="T:GSLNET.GSLFunctions.TDArrayToDArray" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\gslfunctions.h" line="35">
<summary>時刻と入力ベクトルから出力ベクトルを計算する関数</summary>
<param name="t">時刻</param>
<param name="inputs">入力ベクトル</param>
<param name="outputs">出力ベクトル</param>
</member>
<member name="T:GSLNET.GSLFunctions.TDArray" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\gslfunctions.h" line="41">
<summary>時刻と入力ベクトルを与える関数</summary>
<param name="t">時刻</param>
<param name="inputs">入力ベクトル</param>
</member>
<member name="T:GSLNET.GSLFunctions.DToD" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\gslfunctions.h" line="46">
<summary>実数値入力から実数値出力を計算する関数</summary>
<param name="input">実数値入力</param>
<returns>実数値出力</returns>
</member>
<member name="T:GSLNET.RootWithDerivative.SolverType" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="35">
<summary>解法の種類</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.SolverType.Newton" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="37">
<summary>ニュートン法</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.SolverType.Secant" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="39">
<summary>割線法</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.SolverType.Steffenson" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="41">
<summary>ステフェンソンの方法</summary>
</member>
<member name="T:GSLNET.RootWithDerivative.Convergence" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="45">
<summary>収束判定基準</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.Convergence.Residual" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="47">
<summary>残差の収束：|f| ＜ epsabs</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.Convergence.Delta" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="49">
<summary>変化量の収束：|x1-x0| ＜ epsabs + epsrel |x1|</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.ConvergenceType" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="53">
<summary>収束判定基準を設定・取得する</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.RelativeError" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="56">
<summary>相対誤差を設定・取得する</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.AbsoluteError" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="59">
<summary>絶対誤差を設定・取得する</summary>
</member>
<member name="F:GSLNET.RootWithDerivative.DeltaH" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="62">
<summary>微分値径算用差分を設定・取得する</summary>
</member>
<member name="M:GSLNET.RootWithDerivative.Iteration" decl="false" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="65">
<summary>反復計算回数を取得する</summary>
</member>
<member name="M:GSLNET.RootWithDerivative.#ctor(GSLNET.RootWithDerivative.SolverType)" decl="true" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="70">
<summary>コンストラクタ</summary>
<param name="sType">解法の種類</param>
</member>
<member name="M:GSLNET.RootWithDerivative.Solve(GSLNET.GSLFunctions.DToD,System.Int32,System.Double@)" decl="true" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="74">
...
<member name="M:GSLNET.RootWithDerivative.Solve(GSLNET.GSLFunctions.DToD,GSLNET.GSLFunctions.DToD,System.Int32,System.Double@)" decl="true" source="e:\projects\数値計算ライブラリ\gslnet\gslnet\rootwithderivative.h" line="81">
<summary>反復計算によってf(x)=0となるxを求める</summary>
<param name="eFnc">関数f(x)</param>
